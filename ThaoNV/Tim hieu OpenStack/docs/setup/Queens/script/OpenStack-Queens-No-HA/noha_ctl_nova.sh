...
function nova_user_endpoint {
	...
	openstack endpoint create --region RegionOne compute public http://$CTL1_IP_NIC1:8774/v2.1
	openstack endpoint create --region RegionOne compute admin http://$CTL1_IP_NIC1:8774/v2.1
	openstack endpoint create --region RegionOne compute internal http://$CTL1_IP_NIC1:8774/v2.1

...
[1. Tìm hiểu chung về OpenStack](./docs/tim-hieu-chung-OpenStack.md)

[2. Tìm hiểu cấu trúc và thành phần của OpenStack](./docs/cau-truc-va-thanh-phan-openstack.md)

[3. Hướng dẫn sử dụng dashboard](./docs/hdsd-dashboard.md)

[4. Tìm hiểu OpenStack Networking cơ bản](./docs/OpenStack-Networking-basic.md)

[5. Hướng dẫn reset root password của máy ảo CentOS 7 trên OpenStack](./docs/Huong-dan-reset-root-password-may-ao-centos-tren-openstack.md)

[6. Hướng dẫn cài đặt OpenStack Newton trên CentOS 7.3](./docs/hd-caidat-openstack-newton-centos7.md)

[7. Tìm hiểu về migrate máy ảo trong OpenStack](./docs/migration.md)

[8. Hướng dẫn rebuild lại máy ảo trong trường hợp Compute bị chết](evacute.md)
